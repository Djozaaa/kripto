...
def calcForText(text, spaces = False):
    ...
    return letters_freq, bigrams_overlap, bigrams_no_overlap, letters_entropy, redundancy
...
def main():
    ...
    letters_freq_spaces, bigrams_overlap_spaces, bigrams_no_overlap_spaces, letters_entropy_spaces, redundancy_spaces = calcForText(text_with_spaces, True)
    letters_freq_wo_spaces, bigrams_overlap_wo_spaces, bigrams_no_overlap_wo_spaces, letters_entropy_wo_spaces, redundancy_wo_spaces = calcForText(text_wo_spaces)
