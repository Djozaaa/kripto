...
def Encrypt(message, public_key_a):
    e, n = public_key_a  # Розпаковка кортежу
    # Використання стандартного RSA-алгоритму: c = m^e mod n
    return pow(message, e, n)
...
# Форматований вивід шифротексту з великими літерами та без префіксу 0x
